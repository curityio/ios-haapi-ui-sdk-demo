...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
/// When <code>enabled</code> is true, log statements will be available across the IdsvrHaapi frameworks. Default value is <code>false</code>.
/// note:
/// Setting <code>enabled</code> should be done as early as possible before any Haapi objects are instantiated.
